...
@brief  The program will take in a command line argument file name, then call a readIn function.
	...
	storing them into a file. The program uses threads for input/output while simulating cycle times.
**/
//------------------------------------------------------
...
void readConfig(char* filename) throw(runtime_error)
{
	...
	while(!tempQ.empty())
	{
		...
		//checking if log is monitor, file or both
		if (tempS == "Log")
		{
			for(int i = 0; i < 2; i++)
			{	
...
{	
	...
	if (logTo == 'F')
	{
		...
		fout << fixed << 0.000001 << " - Simulator program starting" << endl;
		...
		while(!tempTimer.timerName.empty() && !tempTimer.timerStartValue.empty() && !tempTimer.timerEndValue.empty())
		{
			...
			else if(tempCutStr == "M{a")
			{
				...
				fout << fixed << tempTimer.timerEndValue.front() << " - Process 1: memory allocated at " << &memLocation << endl;
				tempTimer.timerName.pop();
				tempTimer.timerStartValue.pop();
				tempTimer.timerEndValue.pop();
			}
			...
			{
				fout << fixed << tempTimer.timerStartValue.front() << " - Process 1: start projector output" << endl;
				fout << fixed << tempTimer.timerEndValue.front() << " - Process 1: end projector output" << endl;
				tempTimer.timerName.pop();
				tempTimer.timerStartValue.pop();
				tempTimer.timerEndValue.pop();
			}
			...
			{
				fout << fixed << tempTimer.timerStartValue.front() << " - Process 1: start hard drive output" << endl;
				fout << fixed << tempTimer.timerEndValue.front() << " - Process 1: end hard drive output" << endl;
				tempTimer.timerName.pop();
				tempTimer.timerStartValue.pop();
				tempTimer.timerEndValue.pop();
			}
			...
			{
				fout << fixed << tempTimer.timerStartValue.front() << " - Process 1: start hard drive input" << endl;
				fout << fixed << tempTimer.timerEndValue.front() << " - Process 1: end hard drive output" << endl;
				tempTimer.timerName.pop();
				tempTimer.timerStartValue.pop();
				tempTimer.timerEndValue.pop();
	...
	{
		cout << fixed << 0.000001 << " - Simulator program starting" << endl;
		while(!tempTimer.timerName.empty() && !tempTimer.timerStartValue.empty() && !tempTimer.timerEndValue.empty())
		{
			string tempStr = tempTimer.timerName.front();
			string tempCutStr = tempStr.substr(0, 3);
			...
			else if(tempCutStr == "M{a")
			{
				...
				cout << fixed << tempTimer.timerEndValue.front() << " - Process 1: memory allocated at " << &memLocation << endl;
				tempTimer.timerName.pop();
				tempTimer.timerStartValue.pop();
				tempTimer.timerEndValue.pop();
			}
			...
			{
				cout << fixed << tempTimer.timerStartValue.front() << " - Process 1: start projector output" << endl;
				cout << fixed << tempTimer.timerEndValue.front() << " - Process 1: end projector output" << endl;
				tempTimer.timerName.pop();
				tempTimer.timerStartValue.pop();
				tempTimer.timerEndValue.pop();
			}
			...
			{
				cout << fixed << tempTimer.timerStartValue.front() << " - Process 1: start hard drive output" << endl;
				cout << fixed << tempTimer.timerEndValue.front() << " - Process 1: end hard drive output" << endl;
				tempTimer.timerName.pop();
				tempTimer.timerStartValue.pop();
				tempTimer.timerEndValue.pop();
			}
			...
			{
				cout << fixed << tempTimer.timerStartValue.front() << " - Process 1: start hard drive input" << endl;
				cout << fixed << tempTimer.timerEndValue.front() << " - Process 1: end hard drive output" << endl;
				tempTimer.timerName.pop();
				tempTimer.timerStartValue.pop();
				tempTimer.timerEndValue.pop();
